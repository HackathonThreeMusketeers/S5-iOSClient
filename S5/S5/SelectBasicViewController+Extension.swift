//
//  SelectBasicViewController+Extension.swift
//  S5
//
//  Created by 会津慎弥 on 2018/07/08.
...
extension SelectBasicViewController: AVAudioRecorderDelegate, AVAudioPlayerDelegate {
    ...
    func onCompletedSynth(data: Data?, res:URLResponse?, err:Error?) -> Void {
        ...
        let output_file = "file://" + savedir + "/" + ViewController.OUTPUT_FILENAME
